...
const choice = prompt("To get sum of desired number enter 1 ; \n To get product of desired number enter 0");
...
let userNumber = prompt("Enter a number generate sum 1 to n");
