...
penguin.favoriteFoods[penguin.favoriteFoods.length - 1] = "pineapples"; //* * * semicolon after line break
...
const lastFavFood = penguin.favoriteFoods[penguin.favoriteFoods.length - 1];
...
for( obj in penguin.favoriteFoods ) {
  console.log(penguin.favoriteFoods[obj]);
}