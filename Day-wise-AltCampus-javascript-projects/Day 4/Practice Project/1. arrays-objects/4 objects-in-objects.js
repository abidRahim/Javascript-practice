...
penguin["outfit"] = ["hat", "shirt", "pants", "shoes"];
...
let penguinHatType = penguin["outfit"];
...
penguin["outfit"]["accesory"] = "pocket watch";
...
for (obj in penguin.outfit) {
  console.log(penguin["outfit"][obj]);  
}